...
const GlobalFilters = () => {
 ...
 value={selectedMonth || ''}
 className="pl-9 pr-4 py-1.5 text-sm border border-[var(--ios-separator)] rounded-full focus:ring-2 focus:ring-primary-500 focus:border-transparent appearance-none bg-[var(--ios-card)] "
 >
 ...
 <div className="relative">
 <Car className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[var(--ios-text-tertiary)]" />
 <select
 ...
 <div className="relative">
 <Layers3 className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[var(--ios-text-tertiary)]" />
 <select
