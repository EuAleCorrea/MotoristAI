    ...
    <div className="flex flex-wrap gap-2 items-center">
      <div className="relative">
        ...
        <select
          ...
          value={selectedMonth || ''}
          className="pl-9 pr-4 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-full focus:ring-2 focus:ring-primary-500 focus:border-transparent appearance-none bg-white dark:bg-gray-700 dark:text-white"
        >
