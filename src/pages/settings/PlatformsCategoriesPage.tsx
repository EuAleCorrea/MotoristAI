...
const PLATFORM_COLORS = [
 ...
 { id: 'bg-[rgba(255,204,0,0.08)]0', label: 'Amarelo', preview: 'bg-[rgba(255,204,0,0.08)]0' },
 { id: 'bg-[rgba(52,199,89,0.08)]0', label: 'Verde', preview: 'bg-[rgba(52,199,89,0.08)]0' },
 { id: 'bg-[rgba(255,59,48,0.08)]0', label: 'Vermelho', preview: 'bg-[rgba(255,59,48,0.08)]0' },
 { id: 'bg-orange-500', label: 'Laranja', preview: 'bg-orange-500' },
 { id: 'bg-[var(--ios-fill)]0', label: 'Azul', preview: 'bg-[var(--ios-fill)]0' },
 { id: 'bg-purple-500', label: 'Roxo', preview: 'bg-purple-500' },
 { id: 'bg-pink-500', label: 'Rosa', preview: 'bg-pink-500' },
 { id: 'bg-[var(--ios-bg)]0', label: 'Cinza', preview: 'bg-[var(--ios-bg)]0' },
];
...
function PlatformsCategoriesPage() {
 ...
 const [editingPlatformColor, setEditingPlatformColor] = useState('bg-[var(--ios-bg)]0');
 const [newPlatformName, setNewPlatformName] = useState('');
 const [newPlatformColor, setNewPlatformColor] = useState('bg-[var(--ios-bg)]0');
 ...
 setNewPlatformName('');
 setNewPlatformColor('bg-[var(--ios-bg)]0');
 ...
 <Layers3 className="h-6 w-6 text-[var(--ios-accent)] " />
 </div>
 ...
 {/* Tabs */}
 <div className="flex space-x-1 bg-[var(--ios-fill)] p-1 rounded-xl">
 <button
 ...
 <div key={platform.id} className="p-4 hover:bg-[var(--ios-bg)] /50 transition relative group">
 {deletingPlatformId === platform.id ? (
 <div className="absolute inset-0 bg-[rgba(255,59,48,0.08)] flex items-center justify-center gap-4 z-10">
 ...
 <button onClick={() => setEditingPlatformId(null)} className="p-2 text-[var(--ios-text-secondary)] hover:bg-[var(--ios-fill)] rounded-lg">
 <X className="h-4 w-4" />
 </button>
 </div>
 ) : (
 ...
 <span className="text-[var(--ios-text)] font-medium">{platform.name}</span>
 </div>
 ...
 {/* Add Platform Form */}
 {showNewPlatformForm ? (
 <div className="p-4 bg-[var(--ios-bg)] /50 border-t border-[var(--ios-separator)] ">
 <div className="flex items-center gap-3">
 ...
 <button onClick={() => { setShowNewPlatformForm(false); setNewPlatformName(''); }} className="p-2 text-[var(--ios-text-secondary)] hover:bg-[var(--ios-fill)] rounded-lg">
 <X className="h-4 w-4" />
 </button>
 </div>
 </div>
 ...
 <div key={category.id} className="p-4 hover:bg-[var(--ios-bg)] /50 transition relative group">
 ...
 <div className="flex items-center gap-3">
 <Tag className="h-4 w-4 text-[var(--ios-text-tertiary)]" />
 <input
 type="text"
 ...
 autoFocus
 />
 <button onClick={handleSaveCategory} className="p-2 text-[var(--sys-green)] hover:bg-[rgba(52,199,89,0.08)] rounded-lg">
 <Check className="h-4 w-4" />
 </button>
 <button onClick={() => setEditingCategoryId(null)} className="p-2 text-[var(--ios-text-secondary)] hover:bg-[var(--ios-fill)] rounded-lg">
 <X className="h-4 w-4" />
 </button>
 </div>
 ) : (
 ...
 <div className="flex items-center gap-3">
 <Tag className="h-4 w-4 text-[var(--ios-text-tertiary)]" />
 <span className="text-[var(--ios-text)] font-medium">{category.name}</span>
 </div>
 <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
 <button
 ...
 autoFocus
 />
 <button onClick={handleAddCategory} className="p-2 text-[var(--sys-green)] hover:bg-[rgba(52,199,89,0.08)] rounded-lg">
 <Check className="h-4 w-4" />
 </button>
 <button onClick={() => { setShowNewCategoryForm(false); setNewCategoryName(''); }} className="p-2 text-[var(--ios-text-secondary)] hover:bg-[var(--ios-fill)] rounded-lg">
 <X className="h-4 w-4" />
 </button>
 </div>
 </div>
