...
import { useVehicleStore, Vehicle, FinancialStatus, Transmission, Fuel } from '../../../store/vehicleStore';
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-30 bg-white/90 backdrop-blur-sm border-t border-gray-200">
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-4" style={{ paddingBottom: 'calc(4.5rem + env(safe-area-inset-bottom))' }}>
