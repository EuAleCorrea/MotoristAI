...
function Analytics() {
 ...
 <div>
 <h1 className="text-2xl font-bold text-[var(--ios-text)]">Análise Financeira</h1>
 ...
 <h2 className="text-lg font-semibold text-[var(--ios-text)] mb-4">
 ...
 <div className="flex items-center justify-center h-64 text-[var(--ios-text-secondary)]">
 ...
 <div className="bg-[var(--ios-card)] rounded-lg shadow-sm p-6">
 <h2 className="text-lg font-semibold text-[var(--ios-text)] mb-4">Resumo do Período</h2>
 ...
 <p className="mt-1 text-2xl font-bold text-[var(--ios-accent)]">
 ...
 <p className="mt-2 text-2xl font-bold text-[var(--ios-text)]">
