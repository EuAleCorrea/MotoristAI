...
const SettingsPage = () => {
 ...
 { id: 'Financeiro do Veículo', title: 'Financeiro do Veículo', icon: Landmark, iconName: 'Landmark', route: '/despesas/veiculo/financeiro/lista' },
 { id: 'Depreciação', title: 'Depreciação', icon: TrendingDown, iconName: 'TrendingDown', route: '/despesas/veiculo/depreciacao/lista' },
