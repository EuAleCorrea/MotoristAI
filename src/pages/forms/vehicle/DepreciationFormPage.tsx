  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 pb-24">
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 flex justify-between items-start">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Cálculo de Depreciação</h3>
          <p className="text-sm text-gray-500">Acompanhe a desvalorização do seu veículo.</p>
        </div>
      ...
      <div className="pt-6 flex items-center gap-4">
        ...
        <button type="submit" className="flex-1 px-6 py-3 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 transition shadow-sm">Salvar Cálculo</button>
      </div>
    </form>
  );
};
