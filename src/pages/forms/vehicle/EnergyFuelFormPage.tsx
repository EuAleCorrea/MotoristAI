    ...
    <form onSubmit={handleSubmit} className="space-y-6 pb-24">
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6">
        <div className="flex justify-between items-start">
            <div>
                <h3 className="text-lg font-semibold text-gray-900 mb-2">Tipo de Abastecimento</h3>
                <p className="text-sm text-gray-500">Selecione o tipo e preencha os detalhes.</p>
            </div>
            {getIconForFuelType()}
        </div>
        <div className="mt-6">
