...
const OtherFormPage: React.FC = () => {
 ...
 <FormInput id="customCategory" label="Categoria Personalizada" type="text" placeholder="Ex: Doação, Presente" value={customCategory} onChange={e => setCustomCategory(e.target.value)} required icon={<Tag className="w-4 h-4 text-[var(--ios-text-tertiary)]" />} />
