...
const HealthFormPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert('Despesa de saúde salva com sucesso!');
    navigate(-1);
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 pb-24">
      <div className="bg-white rounded-xl shadow-sm p-4 sm:p-6 flex justify-between items-start">
        <div>
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Despesa de Saúde</h3>
          <p className="text-sm text-gray-500">Registre gastos médicos e de bem-estar.</p>
        </div>
