...
function DuplicateModal({ isOpen, monthName, year, onEdit, onOverwrite, onCancel }: DuplicateModalProps) {
 ...
 <div className="bg-[var(--ios-card)] rounded-2xl shadow-2xl max-w-md w-full p-6 animate-in fade-in zoom-in duration-200">
 {/* Header */}
 <div className="flex items-center gap-3 mb-4">
 <div className="p-3 rounded-full bg-[rgba(255,149,0,0.12)] ">
 <AlertTriangle className="w-6 h-6 text-[var(--sys-orange)] " />
 </div>
 <div>
 <h3 className="text-lg font-bold text-[var(--ios-text)]">Meta já existe!</h3>
 ...
 {/* Message */}
 <p className="text-[var(--ios-text-secondary)] mb-6">
 ...
 <button
 onClick={onCancel}
 className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-[var(--ios-separator)] text-[var(--ios-text)] font-semibold rounded-xl hover:bg-[var(--ios-bg)] transition"
 >
 <X className="w-5 h-5" />
 Cancelar
 </button>
